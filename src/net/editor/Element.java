...
public class Element implements Serializable {
	...
	static {
		...
		blocks.add(BLOCK);
		LOOKUP.add(blocks);
		ArrayList<Texture> players = new ArrayList<>();
		players.add(PLAYER);
		LOOKUP.add(players);
		ArrayList<Texture> exits = new ArrayList<>();
		exits.add(EXIT);
		exits.add(EXIT_CLOSED);
		LOOKUP.add(exits);
		ArrayList<Texture> terrains = new ArrayList<>();
		...
		buttons.add(BUTTON);
		LOOKUP.add(buttons);
		ArrayList<Texture> toggles = new ArrayList<>();
		toggles.add(TOGGLE);
		toggles.add(TOGGLE);
		LOOKUP.add(toggles);
		ArrayList<Texture> milks = new ArrayList<>();
		milks.add(MILK_SURFACE);
		LOOKUP.add(milks);
		ArrayList<Texture> lifts = new ArrayList<>();
		lifts.add(LIFT);
		lifts.add(LIFT);
		lifts.add(LIFT);
		lifts.add(LIFT);
